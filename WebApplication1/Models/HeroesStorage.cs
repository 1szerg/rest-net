...
namespace WebApplication1.Models
{
    public class HeroesStorage
    {
        ...
        public static HeroesStorage getInstance()
        {
            return instance;
        }

        public IList<Hero> getAll()
        {
            return heroes;
        }
        ...
        public void updateHero(int id, string name)
        {
            ...
            if (found > -1)
            {
                heroes[found].name = name;
            }
            else {
                heroes.Add(Hero.build(id, name));
            }
        }
